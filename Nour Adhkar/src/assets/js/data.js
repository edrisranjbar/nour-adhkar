...
export const morningCollection = new Collection('اذکار صبحگاه', [
    new Dhikr(
        ...
        'خداوند هیچ معبودى «بحق» جز او نیست، خداوندى که زنده و قائم به ذات خویش است، هیچ گاه خواب سبک و سنگین او را فرا نمی‌گیرد، براى اوست آنچه در آسمان‏ها و زمین است، کیست که نزد او جز به فرمانش شفاعت کند، آنچه را پیش روى آنها «بندگان» و پشت سر آنهاست می‌داند، و از گذشته و آینده‏ى آنان آگاه است، آنها جز به مقدارى که او بخواهد احاطه به علم او ندارند، کرسى او آسمان‏ها و زمین را در برگرفته و حفظ و نگهدارى آسمان و زمین براى او گران نیست، و او بلند مرتبه و باعظمت است',
        1
    ),
    new Dhikr(
        'سوره ی اخلاص',
        ...
        `
        بگو خدا یگانه است، خدا، بى نیاز است، نه زاده، و نه زاده شده است، و نه همتایى دارد.
        `,
        3
    ),
    new Dhikr(
        ...
        'بگو پناه می‌برم به خداوند سپیده دم. از شرّ آنچه آفریده است، و از شرّ شب بدانگاه که کاملاً فرا مىرسد، و از شرّ کسانى که در گره ها می‌دمند، و از شرّ حسود بدانگاه که حسد مىورزد.',
        3
    ),
    new Dhikr(
        'سوره ی ناس',
        ...
        'بگو پناه می‌برم به پروردگار مردمان، به مالِک و حاکِم «واقعى» مردم، به معبودِ «بحقِ» مردم، از شرّ وسوسه‏گرى که واپس مىرود، از وسوه‏گرى است که در سینه‏هاى مردم به وسوسه مىپردازد، «در سینه‏هاى مردمانى» از جن‏ها و انسان‏ها',
        3
    ),
    new Dhikr(
        '',
