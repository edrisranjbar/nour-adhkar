...
class AdhkarSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Sleep Adhkar - Must include ALL adhkar from sleep.js
        $this->seedSleepAdhkar($collections['دعای خواب']->id);
    ...
    private function seedNightAdhkar($collectionId): void
    {
        $adhkar = [
            ...
            [
                ...
                'translation' => 'خدایا! به نام تو می‌میرم و زنده می‌شوم.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                'title' => '',
                'prefix' => '',
                'arabic_text' => 'الْحَمْدُ لِلَّهِ الَّذِي أَطْعَمَنَا وَسَقَانَا، وَكَفَانَا، وَآوَانَا، فَكَمْ مِمَّنْ لَا كَافِيَ لَهُ وَلَا مُؤْوِيَ',
                'translation' => 'ستایش برای خدایی است که به ما غذا و نوشیدنی داد، و ما را کفایت کرد و پناه داد. چه بسیار کسانی که کفایت‌کننده و پناه‌دهنده‌ای ندارند.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
    ...
    private function seedSleepAdhkar($collectionId): void
    {
        $adhkar = [
            [
                'title' => 'دعای خواب',
                'prefix' => '',
                'arabic_text' => 'بِاسْمِكَ اللَّهُمَّ أَمُوتُ وَأَحْيَا',
                'translation' => 'بار الها! به نام تو می‌میرم و زنده می‌شوم',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                ...
                'translation' => 'بار الها! مرا از عذاب خود، روزی که بندگانت را برمی‌انگیزی، محفوظ بدار',
                'count' => 3,
                'collection_id' => $collectionId
            ],
            [
                ...
                'translation' => 'به نام تو پروردگارم پهلویم را بر زمین نهادم و به [یاری] تو آن را برمی‌دارم، پس اگر جانم را گرفتی، پس به آن رحم کن، و اگر آن را رها نمودی پس آن را حفظ کن، به آنچه بندگان نیکوکارت را با آن حفظ می‌کنی.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
            ...
            [
                'title' => '',
                'prefix' => '',
                'arabic_text' => 'اللَّهُمَّ خَلَقْتَ نَفْسِي وَأَنْتَ تَوَفَّاهَا، لَكَ مَمَاتُهَا وَمَحْيَاهَا، إِنْ أَحْيَيْتَهَا فَاحْفَظْهَا، وَإِنْ أَمَتَّهَا فَاغْفِرْ لَهَا، اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَافِيَةَ',
                'translation' => 'خدایا! تو جان مرا آفریدی و تو آن را می‌میرانی، مرگ و زندگی آن از آن توست، اگر آن را زنده نگه داشتی، پس آن را حفظ کن، و اگر آن را میراندی، پس آن را بیامرز. خدایا! من از تو عافیت می‌خواهم.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
            ...
            [
                'title' => '',
                'prefix' => '',
                'arabic_text' => 'اللَّهُمَّ رَبَّ السَّمَوَاتِ وَرَبَّ الْأَرْضِ وَرَبَّ الْعَرْشِ الْعَظِيمِ، رَبَّنَا وَرَبَّ كُلِّ شَيْءٍ، فَالِقَ الْحَبِّ وَالنَّوَى، وَمُنْزِلَ التَّوْرَاةِ وَالْإِنْجِيلِ وَالْفُرْقَانِ، أَعُوذُ بِكَ مِنْ شَرِّ كُلِّ شَيْءٍ أَنْتَ آخِذٌ بِنَاصِيَتِهِ، اللَّهُمَّ أَنْتَ الْأَوَّلُ فَلَيْسَ قَبْلَكَ شَيْءٌ، وَأَنْتَ الْآخِرُ فَلَيْسَ بَعْدَكَ شَيْءٌ، وَأَنْتَ الظَّاهِرُ فَلَيْسَ فَوْقَكَ شَيْءٌ، وَأَنْتَ الْبَاطِنُ فَلَيْسَ دُونَكَ شَيْءٌ، اقْضِ عَنَّا الدَّيْنَ، وَأَغْنِنَا مِنَ الْفَقْرِ',
                'translation' => 'خدایا! ای پروردگار آسمان‌ها و پروردگار زمین و پروردگار عرش بزرگ، پروردگار ما و پروردگار هر چیز، ای شکافنده دانه و هسته و نازل کننده تورات و انجیل و قرآن، از شر هر چیزی که تو اختیار آن را در دست داری به تو پناه می‌برم. خدایا! تو اولی و پیش از تو چیزی نیست، و تو آخری و پس از تو چیزی نیست، و تو ظاهری و بالاتر از تو چیزی نیست، و تو باطنی و نزدیک‌تر از تو چیزی نیست. قرض ما را ادا کن و ما را از فقر بی‌نیاز گردان.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                'title' => '',
                'prefix' => '',
                'arabic_text' => 'اللَّهُمَّ أَسْلَمْتُ نَفْسِي إِلَيْكَ، وَفَوَّضْتُ أَمْرِي إِلَيْكَ، وَوَجَّهْتُ وَجْهِي إِلَيْكَ، وَأَلْجَأْتُ ظَهْرِي إِلَيْكَ، رَغْبَةً وَرَهْبَةً إِلَيْكَ، لَا مَلْجَأَ وَلَا مَنْجَا مِنْكَ إِلَّا إِلَيْكَ، آمَنْتُ بِكِتَابِكَ الَّذِي أَنْزَلْتَ، وَبِنَبِيِّكَ الَّذِي أَرْسَلْتَ',
                'translation' => 'خدایا! خود را به تو تسلیم کردم، و کارم را به تو واگذار نمودم، و رویم را به سوی تو کردم، و به تو اعتماد کردم، از روی رغبت و ترس به سوی تو. پناهگاه و نجاتی از تو جز به سوی تو نیست. به کتابی که نازل کردی و به پیامبری که فرستادی، ایمان آوردم.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                'title' => '',
                'prefix' => '',
                'arabic_text' => 'سُبْحَانَ اللَّهِ ثَلَاثًا وَثَلَاثِينَ، وَالْحَمْدُ لِلَّهِ ثَلَاثًا وَثَلَاثِينَ، وَاللَّهُ أَكْبَرُ أَرْبَعًا وَثَلَاثِينَ',
                'translation' => '33 بار «سبحان الله»، 33 بار «الحمد لله» و 34 بار «الله اكبر» بگوید.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                ...
                'translation' => 'خدایا! به ذات بزرگوارت و به کلمات کاملت از شر آنچه اختیارش را در دست داری، به تو پناه می‌برم. خدایا! تو گرفتاری و گناه را برطرف می‌کنی. خدایا! لشکر تو شکست نمی‌خورد، و وعده تو خلاف نمی‌شود، و ثروت و مقام ثروتمندان و قدرتمندان در برابر تو سودی نمی‌رساند. تو پاک و منزهی و ستایش برای توست.',
                'count' => 1,
                'collection_id' => $collectionId
            ],
            [
                ...
                'translation' => 'پاک و منزه است خداوند و ستایش از آن اوست، به تعداد آفریدگانش، و به اندازه خشنودی‌اش، و به وزن عرشش، و به مقدار کلماتش.',
                'count' => 3,
                'collection_id' => $collectionId
            ]
        ];
